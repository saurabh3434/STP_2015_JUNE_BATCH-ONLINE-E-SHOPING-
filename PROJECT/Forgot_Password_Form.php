...
<table align="center" border='0'>
	<tr>
	<th colspan="2"align="center"><h1><font="green"><u><font color="green">RESET PASSWORD</u></font></h1></th>
	</tr><tr>
		<td align="right">Email</td>
		<td><input type="text" name="txt_mail" placeholder="Enter Mail"></td>
	</tr><tr>
		<td align="right">Mobile No.</td>
		<td><input type="text" name="txt_mob" placeholder="Enter Mobile No."></td>
	</tr><tr>
		<td align="right">Unique Id</td>
		<td><input type="text" name="txt_uid" placeholder="Enter Mobile No."></td>
	</tr><tr>
		<td align="right">New Password</td><td><input type="password" name="txt_pwd" placeholder="Enter Password"></td>
	</tr><tr>
		<td align="right">ReType Password</td><td><input type="password" name="txt_rpwd" placeholder="ReType Password"></td>
	</tr><tr>
		<td colspan="2"align="center"><input type="submit"name="sub_btn" value="UPDATE >>"></td>
	</tr></table>
<?php
if(isset($_POST["sub_btn"])){
	$mail=$_POST["txt_mail"];
	...
	$q1="select u_id from user";
	$q2="select mob_no,mail from user where u_id='$uid'";
	$rec=mysql_query($q1);
	$ui=mysql_fetch_row($rec);
	if(strcmp($ui[0],$uid)==0){
		$rec1=mysql_query($q2);
		$ar=mysql_fetch_row($rec1);
		print_r($ar);
		if(strcmp($mob,$ar[0]==0)&&strcmp($mail,$ar[1]==0)){
			echo("<br>You are successfully signed in");
			$pwd=$_POST["txt_pwd"];
			$rpwd=$_POST["txt_rpwd"];
			if(strcmp($pwd,$rpwd)==0){
				$q="update user set pwd='$pwd' where u_id='$uid'";
				$rec1=mysql_query($q);
			}				
		}	
	}
	else
		echo"$uid user does not exists";
}
?>
</td>
</tr>

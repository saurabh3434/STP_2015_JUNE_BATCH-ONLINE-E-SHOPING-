...
$q="select product_id , product_name , product_price from product where product_id='$arr'";
$rec=mysql_query($q);
$r=mysql_fetch_row($rec);
$products[$arr]=(array($r[0],$r[1],$r[2]));
}
echo"<table border='0'align='center'>";
$total=0;
foreach($products as $arr1){
	echo"<tr>";
	echo"<td width='20%'>$arr1[0]</td>";
	echo"<td width='20%'>$arr1[1]</td>";
	echo"<td width='20%'>$arr1[2]</td>";
	echo"<td width='20%'><a href='Cart_Form.php?txt=remove&id=$arr1[0]'>Remove</a></td>";
	$total=$total+$arr1[2];
	echo"</tr>";
...
echo"</table>";	
echo"<a href='Payment_Form.php'>Want to check out?</a>";
	
	
	
	

echo"<a href='Home_Form.php'>Continue Shopping</a>";
